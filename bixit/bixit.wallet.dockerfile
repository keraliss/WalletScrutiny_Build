...
# Manually install NDK 26.1.10909125
RUN wget https://dl.google.com/android/repository/android-ndk-r26b-linux.zip && \
    unzip android-ndk-r26b-linux.zip -d ${ANDROID_HOME}/ndk && \
    rm android-ndk-r26b-linux.zip && \
    mv ${ANDROID_HOME}/ndk/android-ndk-r26b ${ANDROID_HOME}/ndk/26.1.10909125
