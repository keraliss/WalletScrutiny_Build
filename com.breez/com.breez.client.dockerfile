...
# Clone BreezMobile repository, apply necessary modifications, and build APK
RUN set -ex; \
    ...
    curl -o 017.apk -L https://github.com/breez/breezmobile/releases/download/0.17.lnd/1681054500-1.apk; \
    unzip 017.apk; \
